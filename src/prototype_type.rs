...
impl fmt::Display for PrototypeType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "{}", match &self {
            ...
            PrototypeType::DeconstructibleTileProxy => "deconstructible-tile-proxy",
            ...
            PrototypeType::LogisticRobot => "logistic-robot",
            ...
            PrototypeType::UtilityConstants => "utility-constants",
...
impl FromStr for PrototypeType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "deconstructible-tile-proxy" => Ok(PrototypeType::DeconstructibleTileProxy),
            ...
            "logistic-robot" => Ok(PrototypeType::LogisticRobot),
            ...
            "utility-constants" => Ok(PrototypeType::UtilityConstants),
