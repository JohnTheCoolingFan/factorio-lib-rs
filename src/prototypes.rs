...
pub struct DataTable {
    ambient_sound: HashMap<String, AmbientSoundPrototype>,
    animation: HashMap<String, Animation>,
    editor_controller: HashMap<String, EditorController>,
    font: HashMap<String, Font>,
    god_controller: HashMap<String, GodController>,
    map_gen_settings: HashMap<String, MapGenPresets>,
    map_settings: HashMap<String, MapSettings>,
    mouse_cursor: HashMap<String, MouseCursor>,
    sound: HashMap<String, Sound>,
    spectator_controller: HashMap<String, SpectatorController>,
    sprite: HashMap<String, Sprite>,
    tile_effect: HashMap<String, TileEffect>,
    tips_and_tricks_item_category: HashMap<String, TipsAndTricksItemCategory>,
    trigger_target_type: HashMap<String, TriggerTargetType>,
    wind_sound: HashMap<String, WindSound>,
    achievement: HashMap<String, Achievement>,
    build_entity_achievement: HashMap<String, BuildEntityAchievement>,
    combat_robot_count: HashMap<String, CombatRobotCountAchievement>,
    construct_with_robots_achevement: HashMap<String, ConstructWithRobotsAchievement>,
    deconstruct_with_robots_achievement: HashMap<String, DeconstructWithRobotsAchievement>,
    deliver_by_robots_achievement: HashMap<String, DeliverByRobotsAchievement>,
    dont_build_entity_achievement: HashMap<String, DontBuildEntityAchievement>,
    dont_craft_manually_achievement: HashMap<String, DontCraftManuallyAchievement>,
    dont_use_entity_in_energy_production_achievement: HashMap<String, DontUseEntityInEnergyProductionAchievement>,
    finish_the_game_achievement: HashMap<String, FinishTheGameAchievement>,
    group_attack_achievement: HashMap<String, GroupAttackAchievement>,
    kill_achievement: HashMap<String, KillAchievement>,
    player_damaged_achievement: HashMap<String, PlayerDamagedAchievement>,
    produce_achievement: HashMap<String, ProduceAchievement>,
    produce_per_hour_achievement: HashMap<String, ProducePerHourAchievement>,
    research_achievement: HashMap<String, ResearchAchievement>,
    train_path_achievement: HashMap<String, TrainPathAchievement>,
    ammo_category: HashMap<String, AmmoCategory>,
    autoplace_control: HashMap<String, AutoplaceControl>,
    custom_input: HashMap<String, CustomInput>,
    damage_type: HashMap<String, DamageType>,
    optimized_decorative: HashMap<String, Decorative>,
    arrow: HashMap<String, Arrow>,
    artillery_flare: HashMap<String, ArtilleryFlare>,
    artillery_projectile: HashMap<String, ArtilleryProjectile>,
    beam: HashMap<String, Beam>,
    character_corpse: HashMap<String, CharacterCorpse>,
    cliff: HashMap<String, Cliff>,
    corpse: HashMap<String, CorpsePrototype>,
    rail_remnants: HashMap<String, RailRemnants>,
    deconstructible_tile_proxy: HashMap<String, DeconstructibleTileProxy>,
    entity_ghost: HashMap<String, EntityGhost>,
    accumulator: HashMap<String, Accumulator>,
    artillery_turret: HashMap<String, ArtilleryTurret>,
    beacon: HashMap<String, Beacon>,
    boiler: HashMap<String, Boiler>,
    burner_generator: HashMap<String, BurnerGenerator>,
    character: HashMap<String, Character>,
    arithmetic_combinator: HashMap<String, ArithmeticCombinator>,
    decider_combinator: HashMap<String, DeciderCombinator>,
    constant_combinator: HashMap<String, ConstantCombinator>,
    container: HashMap<String, Container>,
    logistic_container: HashMap<String, LogisticContainer>,
    infinity_container: HashMap<String, InfinityContainer>,
    assembling_machine: HashMap<String, AssemblingMachine>,
    rocket_silo: HashMap<String, RocketSilo>,
    furnace: HashMap<String, Furnace>,
    electric_energy_interface: HashMap<String, ElectricEnergyInterface>,
    electric_pole: HashMap<String, ElectricPole>,
    unit_spawner: HashMap<String, EnemySpawner>,
    fish: HashMap<String, Fish>,
    combat_robot: HashMap<String, CombatRobot>,
    construction_robot: HashMap<String, ConstructionRobot>,
    logistic_robot: HashMap<String, LogisticRobot>,
    gate: HashMap<String, Gate>,
    generator: HashMap<String, Generator>,
    heat_interface: HashMap<String, HeatInterface>,
    heat_pipe: HashMap<String, HeatPipe>,
    inserter: HashMap<String, Inserter>,
    lab: HashMap<String, Lab>,
    lamp: HashMap<String, Lamp>,
    land_mine: HashMap<String, LandMine>,
    linked_container: HashMap<String, LinkedContainer>,
    market: HashMap<String, Market>,
    mining_drill: HashMap<String, MiningDrill>,
    offshore_pump: HashMap<String, OffshorePump>,
    pipe: HashMap<String, Pipe>,
    infinity_pipe: HashMap<String, InfinityPipe>,
    pipe_to_ground: HashMap<String, PipeToGround>,
    player_port: HashMap<String, PlayerPort>,
    power_switch: HashMap<String, PowerSwitch>,
    programmable_speaker: HashMap<String, ProgrammableSpeaker>,
    pump: HashMap<String, Pump>,
    radar: HashMap<String, Radar>,
    curved_rail: HashMap<String, CurvedRail>,
    straight_rail: HashMap<String, StraightRail>,
    rail_chain_signal: HashMap<String, RailChainSignal>,
    rail_signal: HashMap<String, RailSignal>,
    reactor: HashMap<String, Reactor>,
    roboport: HashMap<String, Roboport>,
    simple_entity: HashMap<String, SimpleEntity>,
    simple_entity_with_owner: HashMap<String, SimpleEntityWithOwner>,
    simple_entity_with_force: HashMap<String, SimpleEntityWithForce>,
    solar_panel: HashMap<String, SolarPanel>,
    spider_leg: HashMap<String, SpiderLeg>,
    storage_tank: HashMap<String, StorageTank>,
    train_stop: HashMap<String, TrainStop>,
    linked_belt: HashMap<String, LinkedBelt>,
    loader_1x1: HashMap<String, Loader1x1>,
    loader: HashMap<String, Loader1x2>,
    splitter: HashMap<String, Splitter>,
    transport_belt: HashMap<String, TransportBelt>,
    underground_belt: HashMap<String, UndergroundBelt>,
    tree: HashMap<String, Tree>,
    turret: HashMap<String, TurretPrototype>,
    ammo_turret: HashMap<String, AmmoTurret>,
    electric_turret: HashMap<String, ElectricTurret>,
    fluid_turret: HashMap<String, FluidTurret>,
    /* Commented out until implemented
    unit: HashMap<String, Unit>,
    car: HashMap<String, Car>,
    artillery_wagon: HashMap<String, ArtilleryWagon>,
    cargo_wagon: HashMap<String, CargoWagon>,
    fluid_wagon: HashMap<String, FluidWagon>,
    locomotive: HashMap<String, Locomotive>,
    spider_vehicle: HashMap<String, SpiderVehicle>,
    wall: HashMap<String, Wall>,
    explosion: HashMap<String, Explosion>,
    flame_thrower_explosion: HashMap<String, FlameThrowerExplosion>,
    fire: HashMap<String, FireFlame>,
    stream: HashMap<String, FluidStream>,
    flying_text: HashMap<String, Flyingtext>,
    higlight_box: HashMap<String, HighlightBoxEntity>,
    item_entity: HashMap<String, ItemEntity>,
    item_request_proxy: HashMap<String, ItemRequestProxy>,
    particle_source: HashMap<String, ParticleSource>,
    projectile: HashMap<String, Projectile>,
    resource: HashMap<String, ResourceEntity>,
    rocket_silo_rocket: HashMap<String, RocketSiloRocket>,
    rocket_silo_rocket_shadow: HashMap<String, RocketSiloRocketShadow>,
    smoke_with_trigger: HashMap<String, SmokeWithTrigger>,
    speech_bubble: HashMap<String, SpeechBubble>,
    sticker: HashMap<String, Sticker>,
    tile_ghost: HashMap<String, TileGhost>,
    active_defense_equipment: HashMap<String, ActiveDefenseEquipment>,
    battery_equipment: HashMap<String, BatteryEquipment>,
    belt_immunity_equipment: HashMap<String, BeltImmunityEquipment>,
    energy_shield_equipment: HashMap<String, EnergyShieldEquipment>,
    generator_equipment: HashMap<String, GeneratorEquipment>,
    movement_bonus_equipment: HashMap<String, MovementBonusEquipment>,
    night_vision_equipment: HashMap<String, NightVisionEquipment>,
    roboport_equipment: HashMap<String, RoboportEquipment>,
    solar_panel_equipment: HashMap<String, SolarPanelEquipment>,
    equipment_category: HashMap<String, EquipmentCategory>,
    equipment_grid: HashMap<String, EquipmentGrid>,
    fluid: HashMap<String, Fluid>,
    fuel_category: HashMap<String, FuelCategory>,
    gui_style: HashMap<String, GuiStyle>,
    item: HashMap<String, Item>,
    ammo: HashMap<String, AmmoItem>,
    capsule: HashMap<String, Capsule>,
    gun: HashMap<String, Gun>,
    item_with_entity_data: HashMap<String, ItemWithEntityData>,
    entity_with_label: HashMap<String, ItemWithLabel>,
    item_with_inventory: HashMap<String, ItemWithInventory>,
    blueprint_book: HashMap<String, BlueprintBook>,
    item_with_tags: HashMap<String, ItemWithTags>,
    selection_tool: HashMap<String, SelectionTool>,
    blueprint: HashMap<String, BlueprintItem>,
    copy_paste_tool: HashMap<String, CopyPasteTool>,
    deconstruction_item: HashMap<String, DeconstructionItem>,
    upgrade_item: HashMap<String, UpgradeItem>,
    module: HashMap<String, Module>,
    rail_planner: HashMap<String, RailPlanner>,
    spidertron_remote: HashMap<String, SpidertronRemote>,
    tool: HashMap<String, Tool>,
    armor: HashMap<String, Armor>,
    repair_tool: HashMap<String, RepairTool>,
    item_group: HashMap<String, ItemGroup>,
    item_subgroup: HashMap<String, ItemSubGroup>,
    module_category: HashMap<String, ModuleCategory>,
    noise_expression: HashMap<String, NamedNoiseExpression>,
    noise_layer: HashMap<String, NoiseLayer>,
    optimized_particle: HashMap<String, Particle>,
    recipe: HashMap<String, Recipe>,
    recipe_category: HashMap<String, RecipeCategory>,
    resource_category: HashMap<String, ResourceCategory>,
    shortcut: HashMap<String, Shortcut>,
    technology: HashMap<String, Technology>,
    tile: HashMap<String, Tile>,
    tip_and_tricks_item: HashMap<String, TipsAndTricksItem>,
    trivial_smoke: HashMap<String, TrivialSmoke>,
    tutorial: HashMap<String, Tutorial>,
    utility_constants: HashMap<String, UnilityConstants>,
    utility_sounds: HashMap<String, UtilitySounds>,
    utility_sprites: HashMap<String, UtilitySprites>,
    virtual_signal: HashMap<String, VirtualSignal>,
    bool_setting: HashMap<String, BoolSetting>,
    int_setting: HashMap<String, IntSetting>,
    double_setting: HashMap<String, DoubleSetting>,
    string_setting: HashMap<String, StringSetting>,
    */
}
