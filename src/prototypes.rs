...
pub struct DataTable {
    ...
    god_controller: HashMap<String, Rc<GodController>>,
    map_gen_settings: HashMap<String, Rc<MapGenPresets>>,
    map_settings: HashMap<String, Rc<MapSettings>>,
    mouse_cursor: HashMap<String, Rc<MouseCursor>>,
    sound: HashMap<String, Rc<Sound>>,
    spectator_controller: HashMap<String, Rc<SpectatorController>>,
    sprite: HashMap<String, Rc<Sprite>>,
    tile_effect: HashMap<String, Rc<TileEffect>>,
    tips_and_tricks_item_category: HashMap<String, Rc<TipsAndTricksItemCategory>>,
    trigger_target_type: HashMap<String, Rc<TriggerTargetType>>,
    wind_sound: HashMap<String, Rc<WindSound>>,
    achievement: HashMap<String, Rc<Achievement>>,
    build_entity_achievement: HashMap<String, Rc<BuildEntityAchievement>>,
    combat_robot_count: HashMap<String, Rc<CombatRobotCountAchievement>>,
    construct_with_robots_achevement: HashMap<String, Rc<ConstructWithRobotsAchievement>>,
    deconstruct_with_robots_achievement: HashMap<String, Rc<DeconstructWithRobotsAchievement>>,
    deliver_by_robots_achievement: HashMap<String, Rc<DeliverByRobotsAchievement>>,
    dont_build_entity_achievement: HashMap<String, Rc<DontBuildEntityAchievement>>,
    dont_craft_manually_achievement: HashMap<String, Rc<DontCraftManuallyAchievement>>,
    dont_use_entity_in_energy_production_achievement: HashMap<String, Rc<DontUseEntityInEnergyProductionAchievement>>,
    finish_the_game_achievement: HashMap<String, Rc<FinishTheGameAchievement>>,
    group_attack_achievement: HashMap<String, Rc<GroupAttackAchievement>>,
    kill_achievement: HashMap<String, Rc<KillAchievement>>,
    player_damaged_achievement: HashMap<String, Rc<PlayerDamagedAchievement>>,
    produce_achievement: HashMap<String, Rc<ProduceAchievement>>,
    produce_per_hour_achievement: HashMap<String, Rc<ProducePerHourAchievement>>,
    research_achievement: HashMap<String, Rc<ResearchAchievement>>,
    train_path_achievement: HashMap<String, Rc<TrainPathAchievement>>,
    ammo_category: HashMap<String, Rc<AmmoCategory>>,
    autoplace_control: HashMap<String, Rc<AutoplaceControl>>,
    custom_input: HashMap<String, Rc<CustomInput>>,
    damage_type: HashMap<String, Rc<DamageType>>,
    optimized_decorative: HashMap<String, Rc<Decorative>>,
    arrow: HashMap<String, Rc<Arrow>>,
    artillery_flare: HashMap<String, Rc<ArtilleryFlare>>,
    artillery_projectile: HashMap<String, Rc<ArtilleryProjectile>>,
    beam: HashMap<String, Rc<Beam>>,
    character_corpse: HashMap<String, Rc<CharacterCorpse>>,
    cliff: HashMap<String, Rc<Cliff>>,
    corpse: HashMap<String, Rc<CorpsePrototype>>,
    rail_remnants: HashMap<String, Rc<RailRemnants>>,
    deconstructible_tile_proxy: HashMap<String, Rc<DeconstructibleTileProxy>>,
    entity_ghost: HashMap<String, Rc<EntityGhost>>,
    accumulator: HashMap<String, Rc<Accumulator>>,
    artillery_turret: HashMap<String, Rc<ArtilleryTurret>>,
    beacon: HashMap<String, Rc<Beacon>>,
    boiler: HashMap<String, Rc<Boiler>>,
    burner_generator: HashMap<String, Rc<BurnerGenerator>>,
    character: HashMap<String, Rc<Character>>,
    arithmetic_combinator: HashMap<String, Rc<ArithmeticCombinator>>,
    decider_combinator: HashMap<String, Rc<DeciderCombinator>>,
    constant_combinator: HashMap<String, Rc<ConstantCombinator>>,
    container: HashMap<String, Rc<Container>>,
    logistic_container: HashMap<String, Rc<LogisticContainer>>,
    infinity_container: HashMap<String, Rc<InfinityContainer>>,
    assembling_machine: HashMap<String, Rc<AssemblingMachine>>,
    rocket_silo: HashMap<String, Rc<RocketSilo>>,
    furnace: HashMap<String, Rc<Furnace>>,
    electric_energy_interface: HashMap<String, Rc<ElectricEnergyInterface>>,
    electric_pole: HashMap<String, Rc<ElectricPole>>,
    unit_spawner: HashMap<String, Rc<EnemySpawner>>,
    fish: HashMap<String, Rc<Fish>>,
    combat_robot: HashMap<String, Rc<CombatRobot>>,
    construction_robot: HashMap<String, Rc<ConstructionRobot>>,
    logistic_robot: HashMap<String, Rc<LogisticRobot>>,
    gate: HashMap<String, Rc<Gate>>,
    generator: HashMap<String, Rc<Generator>>,
    heat_interface: HashMap<String, Rc<HeatInterface>>,
    heat_pipe: HashMap<String, Rc<HeatPipe>>,
    inserter: HashMap<String, Rc<Inserter>>,
    lab: HashMap<String, Rc<Lab>>,
    lamp: HashMap<String, Rc<Lamp>>,
    land_mine: HashMap<String, Rc<LandMine>>,
    linked_container: HashMap<String, Rc<LinkedContainer>>,
    market: HashMap<String, Rc<Market>>,
    mining_drill: HashMap<String, Rc<MiningDrill>>,
    offshore_pump: HashMap<String, Rc<OffshorePump>>,
    pipe: HashMap<String, Rc<Pipe>>,
    infinity_pipe: HashMap<String, Rc<InfinityPipe>>,
    pipe_to_ground: HashMap<String, Rc<PipeToGround>>,
    player_port: HashMap<String, Rc<PlayerPort>>,
    power_switch: HashMap<String, Rc<PowerSwitch>>,
    programmable_speaker: HashMap<String, Rc<ProgrammableSpeaker>>,
    pump: HashMap<String, Rc<Pump>>,
    radar: HashMap<String, Rc<Radar>>,
    curved_rail: HashMap<String, Rc<CurvedRail>>,
    straight_rail: HashMap<String, Rc<StraightRail>>,
    rail_chain_signal: HashMap<String, Rc<RailChainSignal>>,
    rail_signal: HashMap<String, Rc<RailSignal>>,
    reactor: HashMap<String, Rc<Reactor>>,
    roboport: HashMap<String, Rc<Roboport>>,
    simple_entity: HashMap<String, Rc<SimpleEntity>>,
    simple_entity_with_owner: HashMap<String, Rc<SimpleEntityWithOwner>>,
    simple_entity_with_force: HashMap<String, Rc<SimpleEntityWithForce>>,
    solar_panel: HashMap<String, Rc<SolarPanel>>,
    spider_leg: HashMap<String, Rc<SpiderLeg>>,
    storage_tank: HashMap<String, Rc<StorageTank>>,
    train_stop: HashMap<String, Rc<TrainStop>>,
    linked_belt: HashMap<String, Rc<LinkedBelt>>,
    loader_1x1: HashMap<String, Rc<Loader1x1>>,
    loader: HashMap<String, Rc<Loader1x2>>,
    splitter: HashMap<String, Rc<Splitter>>,
    transport_belt: HashMap<String, Rc<TransportBelt>>,
    underground_belt: HashMap<String, Rc<UndergroundBelt>>,
    tree: HashMap<String, Rc<Tree>>,
    turret: HashMap<String, Rc<TurretPrototype>>,
    ammo_turret: HashMap<String, Rc<AmmoTurret>>,
    electric_turret: HashMap<String, Rc<ElectricTurret>>,
    fluid_turret: HashMap<String, Rc<FluidTurret>>,
    /* Commented out until implemented
    unit: HashMap<String, Rc<Unit>>,
    car: HashMap<String, Rc<Car>>,
    artillery_wagon: HashMap<String, Rc<ArtilleryWagon>>,
    cargo_wagon: HashMap<String, Rc<CargoWagon>>,
    fluid_wagon: HashMap<String, Rc<FluidWagon>>,
    locomotive: HashMap<String, Rc<Locomotive>>,
    spider_vehicle: HashMap<String, Rc<SpiderVehicle>>,
    wall: HashMap<String, Rc<Wall>>,
    explosion: HashMap<String, Rc<Explosion>>,
    flame_thrower_explosion: HashMap<String, Rc<FlameThrowerExplosion>>,
    fire: HashMap<String, Rc<FireFlame>>,
    stream: HashMap<String, Rc<FluidStream>>,
    flying_text: HashMap<String, Rc<Flyingtext>>,
    higlight_box: HashMap<String, Rc<HighlightBoxEntity>>,
    item_entity: HashMap<String, Rc<ItemEntity>>,
    item_request_proxy: HashMap<String, Rc<ItemRequestProxy>>,
    particle_source: HashMap<String, Rc<ParticleSource>>,
    projectile: HashMap<String, Rc<Projectile>>,
    resource: HashMap<String, Rc<ResourceEntity>>,
    rocket_silo_rocket: HashMap<String, Rc<RocketSiloRocket>>,
    rocket_silo_rocket_shadow: HashMap<String, Rc<RocketSiloRocketShadow>>,
    smoke_with_trigger: HashMap<String, Rc<SmokeWithTrigger>>,
    speech_bubble: HashMap<String, Rc<SpeechBubble>>,
    sticker: HashMap<String, Rc<Sticker>>,
    tile_ghost: HashMap<String, Rc<TileGhost>>,
    active_defense_equipment: HashMap<String, Rc<ActiveDefenseEquipment>>,
    battery_equipment: HashMap<String, Rc<BatteryEquipment>>,
    belt_immunity_equipment: HashMap<String, Rc<BeltImmunityEquipment>>,
    energy_shield_equipment: HashMap<String, Rc<EnergyShieldEquipment>>,
    generator_equipment: HashMap<String, Rc<GeneratorEquipment>>,
    movement_bonus_equipment: HashMap<String, Rc<MovementBonusEquipment>>,
    night_vision_equipment: HashMap<String, Rc<NightVisionEquipment>>,
    roboport_equipment: HashMap<String, Rc<RoboportEquipment>>,
    solar_panel_equipment: HashMap<String, Rc<SolarPanelEquipment>>,
    equipment_category: HashMap<String, Rc<EquipmentCategory>>,
    equipment_grid: HashMap<String, Rc<EquipmentGrid>>,
    fluid: HashMap<String, Rc<Fluid>>,
    fuel_category: HashMap<String, Rc<FuelCategory>>,
    gui_style: HashMap<String, Rc<GuiStyle>>,
    item: HashMap<String, Rc<Item>>,
    ammo: HashMap<String, Rc<AmmoItem>>,
    capsule: HashMap<String, Rc<Capsule>>,
    gun: HashMap<String, Rc<Gun>>,
    item_with_entity_data: HashMap<String, Rc<ItemWithEntityData>>,
    entity_with_label: HashMap<String, Rc<ItemWithLabel>>,
    item_with_inventory: HashMap<String, Rc<ItemWithInventory>>,
    blueprint_book: HashMap<String, Rc<BlueprintBook>>,
    item_with_tags: HashMap<String, Rc<ItemWithTags>>,
    selection_tool: HashMap<String, Rc<SelectionTool>>,
    blueprint: HashMap<String, Rc<BlueprintItem>>,
    copy_paste_tool: HashMap<String, Rc<CopyPasteTool>>,
    deconstruction_item: HashMap<String, Rc<DeconstructionItem>>,
    upgrade_item: HashMap<String, Rc<UpgradeItem>>,
    module: HashMap<String, Rc<Module>>,
    rail_planner: HashMap<String, Rc<RailPlanner>>,
    spidertron_remote: HashMap<String, Rc<SpidertronRemote>>,
    tool: HashMap<String, Rc<Tool>>,
    armor: HashMap<String, Rc<Armor>>,
    repair_tool: HashMap<String, Rc<RepairTool>>,
    item_group: HashMap<String, Rc<ItemGroup>>,
    item_subgroup: HashMap<String, Rc<ItemSubGroup>>,
    module_category: HashMap<String, Rc<ModuleCategory>>,
    noise_expression: HashMap<String, Rc<NamedNoiseExpression>>,
    noise_layer: HashMap<String, Rc<NoiseLayer>>,
    optimized_particle: HashMap<String, Rc<Particle>>,
    recipe: HashMap<String, Rc<Recipe>>,
    recipe_category: HashMap<String, Rc<RecipeCategory>>,
    resource_category: HashMap<String, Rc<ResourceCategory>>,
    shortcut: HashMap<String, Rc<Shortcut>>,
    technology: HashMap<String, Rc<Technology>>,
    tile: HashMap<String, Rc<Tile>>,
    tip_and_tricks_item: HashMap<String, Rc<TipsAndTricksItem>>,
    trivial_smoke: HashMap<String, Rc<TrivialSmoke>>,
    tutorial: HashMap<String, Rc<Tutorial>>,
    utility_constants: HashMap<String, Rc<UnilityConstants>>,
    utility_sounds: HashMap<String, Rc<UtilitySounds>>,
    utility_sprites: HashMap<String, Rc<UtilitySprites>>,
    virtual_signal: HashMap<String, Rc<VirtualSignal>>,
    bool_setting: HashMap<String, Rc<BoolSetting>>,
    int_setting: HashMap<String, Rc<IntSetting>>,
    double_setting: HashMap<String, Rc<DoubleSetting>>,
    string_setting: HashMap<String, Rc<StringSetting>>,
    */
}
